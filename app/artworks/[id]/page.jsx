...
if (!artwork && !loading) {	
	...
	{!loading && artwork && (
      ...
      <div className="container m-auto py-6 px-6">
        ...
        >
          <i className="fas fa-arrow-left mr-2"></i> Back to Artworks
        </Link>
      </div>
    </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          <main>
            ...
            >
              ...
              <div className="flex flex-col md:flex-row justify-around">
                ...
                >
                  ...
                  <div className="text-2xl font-bold text-rose-500">$1,100</div>
                </div>
                <div className="flex items-center justify-center mb-4 pb-4 md:pb-0">
                  <div className="text-gray-500 mr-2 font-bold">Monthly</div>
                  <div className="text-2xl font-bold text-rose-500">$4,200</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <div
                className="flex justify-center gap-4 text-rose-500 mb-4 text-xl space-x-9"
              >
                <p>
