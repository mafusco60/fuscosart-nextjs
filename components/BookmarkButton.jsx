...
const BookmarkButton = ({ artwork }) => {
  ...
  return isBookmarked ? (
    <button
      onClick={handleClick}
      className='bg-red-800 hover:bg-red-600 text-white font-bold w-full py-2 px-4 rounded-full flex items-center justify-center'
    >
    ...
    >
      <FaBookmark className='mr-2' /> Bookmark Artwork
    </button>
  );
};
