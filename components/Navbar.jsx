				...
				<div className='relative flex h-20 items-center justify-between'>
					<div className='absolute inset-y-0 left-0 flex items-center'>
						...
						<button
							...
							className='relative inline-flex items-center justify-center rounded-md p-2 text-rose-900 hover:bg-rose-800 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white md:hidden'
                ...
                {providers &&
                  Object.values(providers).map((provider, index) => (
                    <button
                      ...
                      key={index}
                      className='flex items-center text-white bg--700 bg-rose-900 hover:bg-rose-800 hover:text-white rounded-md px-3 py-2'
                    >
...
{!session &&
              ...
              Object.values(providers).map((provider, index) => (
                <button
                  onClick={() => signIn(provider.id)}
                  key={index}
                  className='flex items-center text-white bg-rose-600 hover:bg-rose-900 hover:text-white rounded-md px-3 py-2'
                >
                  <span>Login or Register</span>
                </button>
              ))}
