        ...
        <div className="relative flex h-20 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center md:items-stretch md:justify-start">
            ...
            <Link className="flex flex-shrink-0 items-center" href="/">
              ...
              <span
                className="hidden md:block  text-white text-4xl 
                ...
                {providers &&
                  Object.values(providers).map((provider, index) => (
                    <button
                      ...
                      key={index}
                      className="flex items-center text-white bg--700 bg-cyan-900 hover:bg-cyan-800 hover:text-white rounded-md px-3 py-2"
                    >
          ...
          {session && (
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 md:static md:inset-auto md:ml-6 md:pr-0">
              <Link href="/messages" className="relative group">
                <button
                  type="button"
                  className="relative rounded-full bg-cyan-200 p-1 text--400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-cyan-800"
                >
              ...
              <div className="relative ml-3">
                <div>
                  <button
                    type="button"
                    className="relative flex rounded-full bg-cyan-950 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-cyan-800"
                    id="user-menu-button"
                    aria-expanded="false"
                    aria-haspopup="true"
